...
def path_for(train=False, val=False, test=False, question=False, answer=False):
    ...
    if question:
        if train:
            return paths.data_path('vqa/Questions/v2_OpenEnded_mscoco_train2014_questions.json')
        else:
            return paths.data_path('vqa/Questions/v2_OpenEnded_mscoco_val2014_questions.json')
    elif answer:
        if train:
            return paths.data_path('vqa/Annotations/v2_mscoco_train2014_annotations.json')
        else:
            return paths.data_path('vqa/Annotations/v2_mscoco_val2014_annotations.json')
